...
if plano_selecionado:
    ...
    with col_m3:
        # Mostra o status comercial baseado na similaridade
    ...
    with col_c1:
        # Montando HTML do plano Concorrente
        itens_html_cong = ""
        for c in coberturas:
            ...
            itens_html_cong += f"""
                <div class="coverage-item">
                    {nomes_coberturas[c]}
                    <span class="badge {badge_class}">{linha_cong[c]}</span>
                </div>
            """
        st.markdown(f"""
    ...
    with col_c2:
        # Montando HTML do plano Unimed Odonto
        itens_html_uni = ""
        for c in coberturas:
            ...
            itens_html_uni += f"""
                <div class="coverage-item">
                    {nomes_coberturas[c]}
                    <span class="badge {badge_class}">{linha_uni[c]}</span>
                </div>
            """
        st.markdown(f"""
